function UserCard({ profile }) {
  return (
    <div className="bg-gray-800 p-4 rounded shadow border border-gray-700 text-center">
      ...
      <a href={profile.html_url} target="_blank" className="text-gray-400 text-sm mt-2" >@{profile.login}</a>
      <p className="text-gray-400 text-sm mt-2" >{profile.bio || 'noting in bio'}</p>
